...
const ReviewIncorrectPage = () => {
  ...
  const handleClearAll = () => {
    if (window.confirm("Are you sure you want to clear all saved incorrect answers?")) {
      ...
      <header className="bg-white border-b border-gray-100 py-10 mb-8 sm:py-12 sm:mb-10">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <button 
            ...
            className="mt-4 text-xs font-bold text-red-500 hover:text-red-700 uppercase tracking-widest transition-colors"
          >
            Clear All History
          </button>
        </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="flex gap-3 w-full sm:w-auto ml-auto">
                  ...
                  {!isCurrentSubmitted ? (
                    ...
                    <button 
                      onClick={currentQuestionIdx === questions.length - 1 ? () => navigate('/') : handleNext}
                    ...
                    >
                      {currentQuestionIdx === questions.length - 1 ? 'Finish Review' : 'Next'}
                    </button>
                  )}
                </div>
              </div>
